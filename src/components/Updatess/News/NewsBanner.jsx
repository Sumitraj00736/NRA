            ...
            <div className='grid grid-cols-1 items-center gap-2 mx-auto max-w-7xl'>
                <div className=' flex flex-col justify-center items-center sm:mt-28 mt-20 px-4 mx-auto'>
                    <div className='flex flex-col gap-4 md:gap-6 justify-center items-center'>
                        <h1 className='text-white font-semibold sm:text-5xl text-4xl text-center spacing'>News & Updates</h1>
                        <p className='tracking-wider text-white sm:text-3xl text-2xl'>News</p>
                        <p className='text-white text-sm sm:text-base text-center'>Have a Look on News.
                        </p>
                        <ul className='flex flex-row gap-3 items-center rounded-3xl bg-white w-sm px-4 py-2 mt-2 mb-4'>
                            ...
                            <HiArrowLongRight />
                            <p className='text-customPurple text-sm sm:text-base'>News</p>
                        </ul>
                    </div>
                </div>
            </div>
