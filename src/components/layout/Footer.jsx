...
function Footer() {
  return (
    <div className="h-auto  bg-customBlue flex flex-col md:flex-row gap-8 justify-between text-[#eae7ef] px-4 md:px-[126px] py-4 md:py-[24px] text-[12px] md:text-[14px]">
