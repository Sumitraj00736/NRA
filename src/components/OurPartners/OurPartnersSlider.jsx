...
const OurPartnersSlider = () => {
  const partners = [
    ...
    { id: 20, logo: "https://i.ibb.co/392MHjtz/ATT-Remit-new-logo-2023.jpg" },
    ...
    { id: 28, logo: "https://i.ibb.co/5gSS7c6L/Whats-App-Image-2025-09-02-at-12-03-33-7308d7a9.jpg"}
  ];

  return (
    <div className="relative w-full max-w-7xl overflow-hidden py-10 mx-auto">
      <style>
        {`
          @keyframes scroll {
            from {
      ...
      <div className="partner-track animate-scroll">
        {[...partners, ...partners].map((partner, index) => (
          <div
            key={index}
            className="flex-shrink-0 w-40 mx-5 transition-transform hover:scale-110"
          >
            <img
              src={partner.logo}
